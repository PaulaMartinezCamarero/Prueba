...
**Objetivos principales:**
  * Estudiar la cantidad de altas hospitalarias por ictus     que hay en cada provincia de Castilla y León y ver como     varían dependiendo del sexo y de la edad.
  * Analizar como el sedentarismo influye dependiendo de la   edad en el riesgo de sufrir un ictus.
  * Estudiar la relación de estar expuesto al humo con la     probabilidad de sufrir un ictus. Además, vamos a ver si     hay más número de centros de ayuda para desintoxicación,    en las provincias en las que más ictus haya habido.
  * Analizar si a peor calidad del aire hay más riesgo de     sufrir un ictus.
